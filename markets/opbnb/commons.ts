...
import { ICommonConfiguration, eOpBNBNetwork } from '../../helpers/types';
...
export const CommonsConfig: ICommonConfiguration = {
  ...
  PoolAdmin: {
    [eOpBNBNetwork.opbnb]: '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266',
  },
  PoolAdminIndex: 0,
  EmergencyAdmin: {
    [eOpBNBNetwork.opbnb]: '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266',
  ...
  ProviderRegistry: {
    ...
    [eOpBNBNetwork.opbnb]: ZERO_ADDRESS,
  },
  ...
  WETH: {
    [eOpBNBNetwork.opbnb]: '0x4200000000000000000000000000000000000006', // bnb: bnb is the base token, bnb is also there, We need Wbnb
  },
  WrappedNativeToken: {
    [eOpBNBNetwork.opbnb]: '0x4200000000000000000000000000000000000006', // bnb: bnb is the base token, bnb is also there, We need Wbnb
  },
